package es.studium.pmdm_t8_accesoapi;
            ...
            case R.id.btnAceptar:
                switch (queAccion)
                {
                    case 0: // Alta
                        ...
                        txtNombre = findViewById(R.id.editTextNombre);
                        txtApellidos =
                                findViewById(R.id.editTextApellidos);
                        txtTelefono = findViewById(R.id.editTextTelefono);
                        alta = new
                                AltaRemota(txtNombre.getText().toString(),
                    ...
                    case 1: // Modificación
                        ...
                        txtTelefono = findViewById(R.id.editTextTelefono);
                        modifica = new
                                ModificacionRemota(txtId.getText().toString(),
    ...
    private class ConsultaRemota extends AsyncTask<Void, Void, String>
    {
        ...
        protected String doInBackground(Void... argumentos)
        {
            try
            {
                ...
                URL url = new
                        URL("http://"+servidor+"/ApiRest/contactos.php");
    ...
    private class AltaRemota extends AsyncTask<Void, Void, String>
    {
        ...
        protected String doInBackground(Void... argumentos)
        {
            try {
                ...
                postDataParams.put("nombreContacto",
                        this.nombreContacto);
                postDataParams.put("apellidosContacto",
                        this.apellidosContacto);
                postDataParams.put("telefonoContacto",
...
String idContacto;
        ...
        protected String doInBackground(Void... voids)
        {
            try
            {
                // Crear la URL de conexión al API
                URI baseUri = new
                        URI("http://"+servidor+"/ApiRest/contactos.php");
                String[] parametros = {"id",this.idContacto};
    ...
    private class ModificacionRemota extends AsyncTask<Void, Void, String>
    {
        ...
        String telefonoContacto;
        // Constructor
        public ModificacionRemota(String id,String nombre, String apellidos,
                                  String telefono)
        {
            this.idContacto = id;
            this.nombreContacto = nombre;
        ...
        protected String doInBackground(Void... voids)
        {
            try
            {
                ...
                Uri uri = new Uri.Builder()
                        ...
                        .appendQueryParameter("nombreContacto",
                                this.nombreContacto)
                        .appendQueryParameter("apellidosContacto",
                                this.apellidosContacto)
                        .appendQueryParameter("telefonoContacto",
                                this.telefonoContacto)
                        .build();
                // Create connection
